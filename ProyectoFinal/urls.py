...
urlpatterns = [
    ...
    path("equipo/", ClubList.as_view(), name="coder-teams"),
    path("equipo/detail/<pk>/", ClubDetail.as_view(), name="coder-team-detail"),
    path("equipo/create/", ClubCreation.as_view(), name="coder-team-create"),
    path("equipo/update/<pk>/", ClubUpdate.as_view(), name="coder-team-update"),
